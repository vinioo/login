<?php
  class Account{
    ...
    public function login($un, $pw){
      ...
      $query = mysqli_query($this->conn, "SELECT * FROM usuarios WHERE username = '$un' AND password = '$pw'");
    ...
    private function insertUserDetails($user, $fn, $ln , $em , $pw){
      ...
      $result = mysqli_query($this->conn, "INSERT INTO usuarios VALUES ('0','$user', '$fn', '$ln', '$em', '$encryptedPw', '$date')");
    ...
    private function validateUsername($user){
      ...
      $checkUsernameQuery = mysqli_query($this->conn, "SELECT username FROM usuarios WHERE username = '$user'");
    ...
    private function validateEmails($em, $em2){
      ...
      $checkEmailQuery = mysqli_query($this->conn, "SELECT username FROM usuarios WHERE email = '$em'");
